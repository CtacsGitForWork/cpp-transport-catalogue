...
namespace map_renderer {
    ...
    // Класс для проекции географических координат на плоскость SVG
    ...
    // Основной класс для визуализации карты маршрутов
    class MapRenderer {
    public:
    ...
    private:
        // Вспомогательные методы для отрисовки элементов карты
